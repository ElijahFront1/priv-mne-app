    ...
    return (
        <Container component="main" maxWidth="xs">
            <Box sx={{ marginTop: 8, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <Box sx={{ mt: 1 }}>
                    <Link component={RouterLink} to={PATH_PAGE.register} variant="body2">
                        Need an account?
                    </Link>
                    ...
                    <Formik
                        ...
                        validationSchema={object().shape({
                            ...
                            password: string().min(5, 'Password must be at least 5 characters long').required('Password is required'),
                        })}
